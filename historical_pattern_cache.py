...
class HistoricalPatternCache:
    def __init__(self):
        self.cache_file = "historical_patterns_cache.json"
        self.historical_data_file = "historical_data_2018_nov2024.csv"
        self.patterns = {}
    ...
    def split_and_save_historical_data(self):
        ...
        # Load main data file
        main_data_file = None
        if os.path.exists('Sales-Table 1.csv'):
            main_data_file = 'Sales-Table 1.csv'
        elif os.path.exists('SalesAthena.csv'):
            main_data_file = 'SalesAthena.csv'
        elif os.path.exists('SalesDataAthenasql (1)/Sales-Table 1.csv'):
            main_data_file = 'SalesDataAthenasql (1)/Sales-Table 1.csv'
        else:
